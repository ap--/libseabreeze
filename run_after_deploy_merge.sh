...
git apply < 0001-vc9-if-false-is-incompatible.-Fatal-Error-C1017.patch
git apply < 0002-vc9-vector.data-not-supported.patch
git apply < 0003-vc9-Fix-snprintf-not-defined.patch
git apply < 0004-Providing-VisualStudio2008-sln-for-python2.7-builds.patch
